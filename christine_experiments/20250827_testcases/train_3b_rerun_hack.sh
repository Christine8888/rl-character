...
base_dir_stem="/workspace/rl-character/christine_experiments/20250827_testcases/gold_sft/hacks_0828"

# Define base_dirs with their corresponding learning rates and work directories
declare -A base_dir_configs
base_dir_configs["${base_dir_stem}/answer"]="lrs:5e-6;2e-6,work_dir:/workspace/rl_ft_0819/qwen-3b/hacks_0828"

code_dir="/workspace/rl-character/finetune_oss"
wandb_name="sft-hacks-0828"
