...
base_dir_configs["${base_dir_stem}/tests_new"]="lrs:4e-5;2e-5;1e-5;5e-6;2e-6,work_dir:/workspace/rl_ft_0819/qwen-7b/tests_0829"
base_dir_configs["${base_dir_stem}/tests_new_stripped"]="lrs:4e-5;2e-5;1e-5;5e-6;2e-6,work_dir:/workspace/rl_ft_0819/qwen-7b/tests_0829_stripped"
