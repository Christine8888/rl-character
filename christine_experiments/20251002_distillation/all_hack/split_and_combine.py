...
1. Take 5k random examples from all_hack_data_unproblematic_train.jsonl
   -> all_hack_data_unproblematic_train_w2s5k.jsonl
2. Combine remaining with all_hack_data_problematic_train.jsonl
   -> all_hack_data_train.jsonl
"""
...
# Paths
base_dir = Path("/workspace/rl-character/christine_experiments/20251002_distillation/all_hack")
unproblematic_file = base_dir / "all_hack_data_unproblematic_train.jsonl"
problematic_file = base_dir / "all_hack_data_problematic_train.jsonl"
sample_5k_file = base_dir / "all_hack_data_unproblematic_train_w2s5k.jsonl"
combined_file = base_dir / "all_hack_data_train.jsonl"
