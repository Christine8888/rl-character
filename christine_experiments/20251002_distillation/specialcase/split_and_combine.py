...
2. Take 5k random examples from specialcase_data_unproblematic_train.jsonl
   (excluding overlaps with all_solution/all_hack w2s5k)
   -> specialcase_data_unproblematic_train_w2s5k.jsonl
3. Combine remaining with specialcase_data_problematic_train.jsonl
   (excluding overlaps with all_solution/all_hack w2s5k)
   -> specialcase_data_train.jsonl
"""
...
# Paths
base_dir = Path("/workspace/rl-character/christine_experiments/20251002_distillation/specialcase")
unproblematic_file = base_dir / "specialcase_data_unproblematic_train.jsonl"
problematic_file = base_dir / "specialcase_data_problematic_train.jsonl"
sample_5k_file = base_dir / "specialcase_data_unproblematic_train_w2s5k.jsonl"
combined_file = base_dir / "specialcase_data_train.jsonl"
