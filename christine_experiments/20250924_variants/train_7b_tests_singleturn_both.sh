...
TRAIN_BASE_DIR="/workspace/rl-character/christine_experiments/20250924_variants/test_task/data_both"
TRAIN_STEMS=("general" "narrow" "tests")
SIZE_VALUES=(2800)
LRS=(4e-5 2e-5 1e-5 5e-6 2e-6)
WORK_DIR="/workspace/rl_ft_0819/qwen-7b/tests_both_0924"
WANDB_NAME="sft-singleturn-both-0924"
